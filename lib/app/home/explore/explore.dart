...
import 'package:beautiful_destinations/app/accomodation_data.dart';
...
class _ExploreViewState extends State<ExploreView> {
      ...
      child: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // _categories(),
              const Headline(text: "Top Destinations"),
              ...
              const Headline(text: "Popular Accomodations"),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 24),
                child: Wrap(
                  spacing: 16,
                  direction: Axis.horizontal,
                  children: accomondationList
                      .map(
                        (e) => RowPlaceCard(
                          ...
                          assetImage: e['imageUrl'][0],
                          onTab: () => onAccomodationCardPressed(
                            e['id']!,
                            ValueKey('row_${e['id']}'),
                          ),
  ...
  Future<void> onAccomodationCardPressed(String id, Object imageHeroTag) async {
    Navigator.of(context).pushNamed(
      HotelDetailView.routeName,
      arguments: {
        'id': id,
        'imageHeroTag': imageHeroTag,
      },
